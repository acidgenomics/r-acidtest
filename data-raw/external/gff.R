...
system2("head -n 1000 ensembl.gff3 > ensembl_head.gff3")
...
system2("head -n 1000 gencode.gtf > gencode_head.gtf")
...
system2("head -n 1000 gencode.gff3 > gencode_head.gff3")
...
system2("head -n 1000 refseq.gff > refseq_head.gff")
...
system2("head -n 1000 flybase.gtf > flybase_head.gtf")
...
system2("head -n 1000 wormbase.gtf > wormbase_head.gtf")
